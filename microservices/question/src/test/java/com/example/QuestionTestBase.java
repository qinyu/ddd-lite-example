...
import com.example.question.config.ResetDbListener;
...
@SpringBootTest(webEnvironment = RANDOM_PORT, classes = {QuestionTestApplication.class})
...
@ActiveProfiles("test")
public abstract class QuestionTestBase {
    @LocalServerPort
    private int port;
    ...
    public abstract User prepareUser(String name, String email);
